...
public class Main {
  ...
  public static TreeNode getRightMostNode(TreeNode leftNode, TreeNode root){
      TreeNode rightMostNode = leftNode;
      
      while(rightMostNode.right != null && rightMostNode.right != root){
  ...
  public static class BSTIterator {
    ...
    private void createThread(){
        while(leftNode != null){//all threads created
            TreeNode rightMostNode = getRightMostNode(leftNode, node);
    ...
    public int next() {
        ...
        if(leftNode == null){
            ...
            TreeNode rightMostNode = getRightMostNode(leftNode, node);
            if(rightMostNode.right == null){//create threads in left subtree
                createThread();
            }
